...
function CompanyEmployees(props: CompanyEmployeesTypes.IProps) {
  const {
    ...
    clearRemovedEmployeesState, getEmployeesExcel,
  } = props;
  ...
  const onDownloadReport = () => getEmployeesExcel && getEmployeesExcel();
      ...
      <TableEmployeesWithPagination
        ...
        actionButtons={
          <div className="d-flex">
            <Button onClick={onDownloadReport} className="button--type-additional excel-icon-wrap mr-24">
              <Image
                src={IconExcel}
                alt="excel icon"
